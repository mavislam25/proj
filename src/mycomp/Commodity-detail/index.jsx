...
import Chart from '../Rechart/Commodity-Chart/index'
  ...
  const useStyles = makeStyles((theme) => ({
    ...
    return (
        <div className="chart-table">
            <Paper className="charttablecontainer" elevation={1}>
            ...
            <div className="chart">
                <Chart data={data} grid dataKey0="Time" dataKey1={SeletedCountry} Currency={SeletedCurrency} Unit={SeletedUnit}/>
            </div>
